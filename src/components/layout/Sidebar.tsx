...
export default function Sidebar() {
    ...
    return (
      <div key={item.title}>
        <Link
          ...
          className={`flex items-center justify-between px-4 py-2.5 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors ${
  ...
  return (
    <>
      ...
      <aside className={`fixed lg:sticky top-0 left-0 h-screen bg-white flex-col overflow-y-auto z-50 transition-all duration-300 ease-in-out overflow-hidden ${
        isOpen ? 'translate-x-0 w-64 border-r border-gray-200 flex' : '-translate-x-full lg:translate-x-0 w-0 lg:w-0 border-0 hidden lg:flex'
      }`}>
        {/* Logo */}
