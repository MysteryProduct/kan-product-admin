                ...
                <div className="w-full max-w-6xl overflow-hidden rounded-2xl bg-[var(--color-bg-primary)] overlay-surface ">
                    <div className="bg-[var(--color-primary)] px-6 py-5 ">
                        <div className="flex items-center justify-between gap-3">
                            <div>
                                <h2 className="text-2xl font-bold text-white">แก้ไขใบขายสินค้า</h2>
                            </div>
                            <button
                                onClick={onClose}
                                disabled={isSubmitting}
                                className="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-2 text-[var(--color-text-primary)] transition-colors hover:border-[var(--color-primary)] hover:bg-[var(--color-bg-tertiary)]"
                                type="button"
                            >
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-gray-300/40 p-4 backdrop-blur-sm">
                    <div className="w-full max-w-4xl overflow-hidden rounded-2xl bg-[var(--color-bg-primary)] overlay-surface ">
                        ...
                        <div className="flex items-center justify-between border-t border-gray-200 px-6 py-4 dark:border-gray-700">
                            <span className="text-sm text-gray-600 dark:text-gray-400">เลือกแล้ว {selectedCount} รายการ</span>
